app.controller('contactusController',['$scope', '$rootScope','contactusService', function($scope,$rootScope, contactusService) {
...
$scope.ClickSubmit = function() {
  ...
  if($scope.firstname==undefined){return;}
  if($scope.lastname==undefined){return;}
  if($scope.phonenumber==undefined){return;}
  if($scope.LEADCF19==undefined){return;}
  if($scope.LEADCF31==undefined){return;}
  if($scope.LEADCF27==undefined){return;}
  if($scope.LEADCF32==undefined){return;}
  if($scope.eventdate==undefined){return;}
  if($scope.currency_name==undefined){return;}
  if($scope.budget==undefined){return;}
  if($scope.addtionalcomments==undefined){return;}
  if($scope.LEADCF28==undefined){return;}
  ...
  var contentObj = {
    ...
    mobilecellnumber:$scope.mobilecellnumber,
    LEADCF19:$scope.LEADCF19,
    LEADCF18:$scope.LEADCF18,
    companywebsite:$scope.companywebsite,
    LEADCF31:$scope.LEADCF31,
    LEADCF20:$scope.LEADCF20,
    LEADCF27:$scope.LEADCF27,
    LEADCF32:$scope.LEADCF32,
    eventdate:$scope.eventdate,
    LEADCF19:$scope.LEADCF19,
    LEADCF18:$scope.LEADCF18,
    eventcity:$scope.eventcity,
    eventvenuename:$scope.eventvenuename,
    eventnumberofguest:$scope.eventnumberofguest,
    LEADCF26:$scope.LEADCF26,
    currency_name:$scope.currency_name,
    addtionalcomments:$scope.addtionalcomments,
    LEADCF28:$scope.LEADCF28
  };

  contactusService.saveContactus(contentObj).then(function(data) {
